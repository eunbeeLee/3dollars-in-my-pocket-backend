...
class StoreDistanceGroupTest {

    @MethodSource("source_under_fifty")
    @ParameterizedTest
    void UNDER_FIFTY_50미만인경우(double distance) {
        // when
        StoreDistanceGroup type = StoreDistanceGroup.of(distance);

        // then
        assertThat(type).isEqualTo(StoreDistanceGroup.UNDER_FIFTY);
    }
    ...
    void FIFTY_TO_HUNDRED_50이상_100미만인경우(double distance) {
        ...
        // then
        assertThat(type).isEqualTo(StoreDistanceGroup.FIFTY_TO_HUNDRED);
    }
    ...
    void HUNDRED_TO_FIVE_HUNDRED_100이상_500미만인경우(double distance) {
        ...
        // then
        assertThat(type).isEqualTo(StoreDistanceGroup.HUNDRED_TO_FIVE_HUNDRED);
    }
    ...
    void FIVE_HUNDRED_TO_THOUSAND_500이상_1000미만인경우(double distance) {
        ...
        // then
        assertThat(type).isEqualTo(StoreDistanceGroup.FIVE_HUNDRED_TO_THOUSAND);
    }
    ...
    void OVER_THOUSAND_1000이상인경우(double distance) {
        ...
        // then
        assertThat(type).isEqualTo(StoreDistanceGroup.OVER_THOUSAND);
    }
